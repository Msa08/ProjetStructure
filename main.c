...
/*____________________________TEST PARTIE 1__________________________________________________________*/
    ...
    // for(i=50000; time<0.0020;i++){// tant que time< 2 millième de sec itérer
    //
    //     time_initial=clock();
    ...
    // generation de clé publique et privé associé à : a et b
    long n;
    long u;
    long s;
